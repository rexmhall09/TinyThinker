# TinyThinker
An improved version of TinyTalker. We have added improvements to tokenizer and trainer as well as a thinking token
...
2) Run train.py to train it. (Inside it you can change batch_size, max_iters, learning_rate to match your needs)
